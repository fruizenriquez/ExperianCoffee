...
login_email = 'fruizenriquez@gmail.com'
login_password = 'F3rn4nd0'

# open chromedriver
driver = webdriver.Chrome('C:/scraper/chromedriver')
time.sleep(2)
...
# We have 1 page of data, 4 rows in total
# 8 columns per table, so 4 * 8 = 32 cells
cells = 32
